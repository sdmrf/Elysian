...
export { PORT, MONGO_URI, JWT_SECRET, DB_NAME, CLOUDINARY_CLOUD_NAME, CLOUDINARY_API_KEY, CLOUDINARY_API_SECRET, MAIL_SERVICE, MAIL_USER, MAIL_EMAIL, MAIL_PASS, MAIL_HOST, MAIL_PORT};